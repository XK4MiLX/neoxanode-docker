...
RUN wget https://github.com/firoorg/firo/releases/download/v0.14.9.2/firo-0.14.9.2-linux64.tar.gz -P /tmp
RUN tar xzvf /tmp/firo-0.14.9.2-linux64.tar.gz -C /tmp \
&& cp /tmp/firo-738308bfcb13/bin/* /usr/local/bin
